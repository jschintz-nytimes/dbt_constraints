{# Bigquery does not currently support unique or not null constraints#}
...
{# Bigquery specific implementation to create a foreign key - enforcement not supported yet#}
{%- macro bigquery__create_foreign_key(pk_table_relation, pk_column_names, fk_table_relation, fk_column_names, verify_permissions, quote_columns, constraint_name, lookup_cache) -%}
...
{%- set table_privileges = bigquery__lookup_table_privileges(table_relation, lookup_cache) -%}
...
{%- macro bigquery__lookup_table_privileges(table_relation, lookup_cache) -%}
...
{%- macro bigquery__lookup_table_columns(table_relation, lookup_cache) -%}
